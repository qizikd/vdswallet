...
func DialHTTPWithClient(endpoint string, client *http.Client, cfg *AuthCfg) (*Client, error) {
...
func DialHTTP(endpoint string,cfg *AuthCfg) (*Client, error) {
	return DialHTTPWithClient(endpoint, new(http.Client), cfg)
}
